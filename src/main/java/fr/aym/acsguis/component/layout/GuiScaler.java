...
{
    //TODO DOC
    default float[] getScale(ScaledResolution res, int mcWidth, int scaledWidth, float guiWidth, int mcHeight, int scaledHeight, float guiHeight) {
     ...
     */
    float getScaleX(ScaledResolution res, int mcWidth, int scaledWidth, float guiWidth);
     ...
     */
    float getScaleY(ScaledResolution res, int mcHeight, int scaledHeight, float guiHeight);
    ...
    {
        @Override
        public float getScaleX(ScaledResolution res, int mcWidth, int scaledWidth, float guiWidth) {
            return 1;
        }

        @Override
        public float getScaleY(ScaledResolution res, int mcHeight, int scaledHeight, float guiHeight) {
            return 1;
        }
    }
    ...
    class AdjustToScreenSize implements GuiScaler
    {
        ...
        @Override
        public float[] getScale(ScaledResolution res, int mcWidth, int scaledWidth, float guiWidth, int mcHeight, int scaledHeight, float guiHeight) {
