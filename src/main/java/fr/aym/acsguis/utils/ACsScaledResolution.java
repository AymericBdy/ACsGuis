...
public class ACsScaledResolution
{
    ...
    public ACsScaledResolution(Minecraft minecraftClient) {
        this(minecraftClient, minecraftClient.displayWidth, minecraftClient.displayHeight);
    }

    public ACsScaledResolution(Minecraft minecraftClient, int displayWidth, int displayHeight)
    {
