...
public enum CssColors
{
  ...
  private CssColors(@Nonnull final String sName,
  ...
  @Nullable
  public static CssColors getFromNameCaseInsensitiveOrNull (@Nullable final String sName)
  {
    for(CssColors colors : values()) {
      if(colors.m_sName.equals(sName)) {
        return colors;
      }
    }
    return null;
