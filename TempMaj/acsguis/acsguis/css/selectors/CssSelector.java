...
public class CssSelector<T>
{
    ...
    public boolean applies(GuiComponent<?> to, EnumSelectorContext targetContext) {
        if(targetContext != null && context != EnumSelectorContext.NORMAL && to.getStyle().getContext() != context && !(context == EnumSelectorContext.HOVER && to.getStyle().getContext() == EnumSelectorContext.ACTIVE)) //TODO proper selector hierarchy system
        {
